...
import { Locations, Permissions } from 'expo';
		...
		if (status === 'denied') {
			return (
				<View style={styles.center}>
					...
					<Text>
						You denied your location. You can fix this by visi- ting your settings and enabling location services for this app.
					</Text>
				</View>
			);
		}
					...
					<View style={styles.metricContainer}>
						<View style={styles.metric}>
							...
							<Text style={[styles.subHeader, {color: white}]}>
							  {Maths.round(coords.altitude * 3.2808)} feet
							</Text>
						</View>
						<View style={styles.metric}>
							<Text style={[styles.header, {color: white}]}>
